...
#define GRIN "\033[1;32m"                                                                       #define RES "\033[0m"                                                                          // функция разлажить на биты var1 var2                                                          int bits_var (int var_v)                                                                        {                                                                                                       for (int i = 31; i >= 0; i --)
        {                                                                                                        int bit = (var_v >> i) & 1;                                                                     if (bit == 1) { printf(SIN" 1"RES); }                                                           else { printf(" 0"); }                                                                          if (i % 8 == 0) { printf(GRIN" |"RES); }                                                }
        printf(SIN" %d\n"RES, var_v);
        return 0;
}
// функция разложить на биты res
