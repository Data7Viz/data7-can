...
Попытка внедрить Fibonacci Factorial Euclid + Neuron для анализа ID J1939. Зачем всё это? Применять в жизни. Проект на стадии разрабоки.
...
<img width="1200" height="1920" alt="692" src="https://github.com/user-attachments/assets/ae2e1f83-75e8-4e75-beee-5c7a5583e553" />
...
- только на 12-м ряду система стабилизируется .618.
- 4 ряд с одной стороны 0.5 с другой 2 
- 5 ряд с одной стороны 0.6 с другой 1.5
...
Сложилось у меня такое мнение, что Факториа и Фибоначчи прямого входа нет. В то врямя как в алгоритме Евклида их два. Чтобы разобраться с управлением нужно опуститься к битам и байтам. Ниже уже не куда. Ниже бит транзисторы. 

- Если пару Фибонначи подключить к Евклиду мы будем всегда видеть НОД = 2.
- Ведь речь идёт о паре кроликов = 2.
- CAN-H CAN-L = 2.
- Биты два состояния = 2. 
- Логический элемент И / ИЛИ два входа = 2.
