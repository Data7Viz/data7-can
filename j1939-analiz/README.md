...
- **Дс.Пр** - дистанция ли расстояние от последнего сообщщения до финиша лога
...
### Изучаю межфреймовое пространство 
...
### Убрал сырое время добавил номера строк читаем от 0
